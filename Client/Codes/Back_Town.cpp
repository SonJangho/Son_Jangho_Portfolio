#include "stdafx.h"
#include "..\Headers\Back_Town.h"
#include "Camera.h"

CBack_Town::CBack_Town(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

HRESULT CBack_Town::Ready_GameObject()
{
...
_int CBack_Town::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CBack_Town::Render_GameObject()
{
...
HRESULT CBack_Town::SetUp_TileInfo()
{
	_ulong			dwByte = 0;

	HANDLE			hFile = CreateFile(L"../Bin/Data/TownTile.dat", GENERIC_READ, 0, nullptr, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, 0);
	if (0 == hFile)
		return E_FAIL;
...
HRESULT CBack_Town::SetUp_Resource()
{
	...
	// For.Texture
	m_pTexture = (CTexture*)m_pResource_Manager->Get_Resource(CResource_Manager::TYPE_STATIC, L"Resource_Texture_TownTiles");
...
HRESULT CBack_Town::SetUp_RenderState()
{
...
HRESULT CBack_Town::Reset_RenderState()
{
...
_matrix CBack_Town::Render_TransForm(CGameObject* pCamera)
{
...
_bool CBack_Town::isDraw(CGameObject * pCamera)
{
...
CBack_Town * CBack_Town::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CBack_Town*		pInstance = new CBack_Town(pGraphic_Device);

	if (FAILED(pInstance->Ready_GameObject()))
	{
		_MSG_BOX("CBack_Town Created Failed");
