...
HRESULT CGraphic_Device::Ready_Graphic_Device(WINMODE eMode, const _uint& iBackCX, const _uint& iBackCY)
{
	...
	// 장치를 생성한다.
	if (FAILED(m_pSDK->CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, g_hWnd, dwBehaviorFlags, &d3dpp, &m_pGraphic_Device)))
		return E_FAIL;
