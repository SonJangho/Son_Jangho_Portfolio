#include "stdafx.h"
#include "..\Headers\Back_House.h"
#include "Camera.h"

CBack_House::CBack_House(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

HRESULT CBack_House::Ready_GameObject()
{
...
_int CBack_House::Update_GameObject(const _float & fTimeDelta)
{
...
_int CBack_House::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CBack_House::Render_GameObject()
{
...
HRESULT CBack_House::SetUp_TileInfo()
{
	_ulong			dwByte = 0;
...
HRESULT CBack_House::SetUp_Resource()
{
...
HRESULT CBack_House::SetUp_RenderState()
{
...
HRESULT CBack_House::Reset_RenderState()
{
...
_matrix CBack_House::Render_TransForm(CGameObject* pCamera)
{
...
_bool CBack_House::isDraw(CGameObject * pCamera)
{
...
CBack_House * CBack_House::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CBack_House*		pInstance = new CBack_House(pGraphic_Device);

	if (FAILED(pInstance->Ready_GameObject()))
	{
		_MSG_BOX("CBack_House Created Failed");
