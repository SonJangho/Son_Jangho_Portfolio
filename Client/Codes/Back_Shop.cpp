#include "stdafx.h"
#include "..\Headers\Back_Shop.h"
#include "Camera.h"

CBack_Shop::CBack_Shop(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

HRESULT CBack_Shop::Ready_GameObject()
{
...
_int CBack_Shop::Update_GameObject(const _float & fTimeDelta)
{
...
_int CBack_Shop::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CBack_Shop::Render_GameObject()
{
...
HRESULT CBack_Shop::SetUp_TileInfo()
{
	_ulong			dwByte = 0;

	HANDLE			hFile = CreateFile(L"../Bin/Data/ShopTile.dat", GENERIC_READ, 0, nullptr, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, 0);
	if (0 == hFile)
		return E_FAIL;
...
HRESULT CBack_Shop::SetUp_Resource()
{
...
HRESULT CBack_Shop::SetUp_RenderState()
{
...
HRESULT CBack_Shop::Reset_RenderState()
{
...
_matrix CBack_Shop::Render_TransForm(CGameObject* pCamera)
{
...
_bool CBack_Shop::isDraw(CGameObject * pCamera)
{
...
CBack_Shop * CBack_Shop::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CBack_Shop*		pInstance = new CBack_Shop(pGraphic_Device);

	if (FAILED(pInstance->Ready_GameObject()))
	{
		_MSG_BOX("CBack_Shop Created Failed");
