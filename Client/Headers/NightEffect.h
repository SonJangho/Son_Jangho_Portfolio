...
// 로고의 배경이다.
class CNightEffect final : public CGameObject
{
private:
	explicit CNightEffect(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CNightEffect() = default;
public:
...
public:
	static CNightEffect* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
protected:
	virtual void Free();
};
