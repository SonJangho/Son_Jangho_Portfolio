...
class CBack_Road final : public CGameObject
{
private:
	explicit CBack_Road(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CBack_Road() = default;
public:
...
public:
	static CBack_Road* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
protected:
	virtual void Free();
};
