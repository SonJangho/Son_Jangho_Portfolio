...
class CBack_Stage final : public CGameObject
{
private:
	explicit CBack_Stage(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CBack_Stage() = default;
public:
...
public:
	static CBack_Stage* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
protected:
	virtual void Free();
};
