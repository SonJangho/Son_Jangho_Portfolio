...
class CGameObject;
class CScene_Shop final : public CScene
{
private:
	explicit CScene_Shop(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CScene_Shop() = default;
public:
...
public:
	static CScene_Shop* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual void Free();
};
