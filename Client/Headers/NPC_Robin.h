...
class CNPC_Robin final : public CGameObject
{
private:
	explicit CNPC_Robin(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CNPC_Robin() = default;
public:
...
public:
	static CNPC_Robin* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
protected:
	virtual void Free();
};
