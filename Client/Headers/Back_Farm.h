...
class CBack_Farm final : public CGameObject
{
private:
	explicit CBack_Farm(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CBack_Farm() = default;
public:
...
public:
	static CBack_Farm* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
protected:
	virtual void Free();
};
