...
class CNPC_Vincent final : public CGameObject
{
private:
	explicit CNPC_Vincent(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CNPC_Vincent() = default;
public:
...
public:
	static CNPC_Vincent* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
protected:
	virtual void Free();
};
