...
class CBack_House final : public CGameObject
{
private:
	explicit CBack_House(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CBack_House() = default;
public:
...
public:
	static CBack_House* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
protected:
	virtual void Free();
};
