...
class CGameObject;
class CScene_Town final : public CScene
{
private:
	explicit CScene_Town(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CScene_Town() = default;
public:
...
public:
	static CScene_Town* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual void Free();
};
